        ...
        <div className="flex flex-col gap-3">
          {episodes.map(ep => (
            <div key={ep.id} className="flex items-center gap-4 border border-border rounded-2xl p-4">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center shrink-0 text-white bg-linear-to-br from-primary to-secondary overflow-hidden">
                {ep.image_url ? (
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-text-muted mt-1">Guest · {ep.guest_role} · {formatDisplayDate(ep.date)}</p>
              </div>
