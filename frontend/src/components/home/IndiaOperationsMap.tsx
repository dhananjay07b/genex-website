...
// world.svg uses Mercator projection — y must use log(tan()) formula, not linear
...
// Keep legacy export alias so existing imports in Home.tsx continue working
export { WorldOperationsMap as IndiaOperationsMap }
